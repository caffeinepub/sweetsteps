...
import type { RewardType as _RewardType, TimeRange as _TimeRange, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addReward(arg0: RewardType): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addReward(to_candid_RewardType_n1(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteCallerUserData(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteCallerUserData();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRewardsForCaller(arg0: TimeRange): Promise<InventorySummary> {
        if (this.processError) {
            try {
                const result = await this.actor.getRewardsForCaller(to_candid_TimeRange_n8(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function to_candid_RewardType_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: RewardType): _RewardType {
    return to_candid_variant_n2(_uploadFile, _downloadFile, value);
}
function to_candid_TimeRange_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: TimeRange): _TimeRange {
...
function to_candid_variant_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: RewardType): {
    chocolateSlab: null;
} | {
    tinyChocolate: null;
} | {
    ...
    return value == RewardType.chocolateSlab ? {
        chocolateSlab: null
    } : value == RewardType.tinyChocolate ? {
        tinyChocolate: null
    } : value == RewardType.chocolateBar ? {
        chocolateBar: null
    } : value;
}
...
function to_candid_variant_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: TimeRange): {
    all: null;
} | {
    month: null;
} | {
